...
def test_static_ui_contract() -> None:
    ...
    assert "const FULL_MIN = 0" in html and "const FULL_MAX = 24000" in html
    ...
    assert "previous_signal_dbm" in html
    assert "previous_rssi_dbm" in html
    assert "formatAge" in html
    assert "formatExactTime" in html
    assert "formatPresenceState" not in html
    assert "formatRiskSummary" in html
    assert "formatManagementSummary" in html
    assert "formatServiceSummary" in html
    ...
    assert "function formatReferenceStatus" in html
